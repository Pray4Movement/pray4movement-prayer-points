...
class Pray4Movement_Prayer_Points_Site_Links {
    public $type = 'pray4movement_prayer_points';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Pray4Movement Prayer Points' );
        return $type;
    }
}
Pray4Movement_Prayer_Points_Site_Links::instance();
