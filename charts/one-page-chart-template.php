...
class Pray4Movement_Prayer_Points_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'pray4movement-prayer-points-metrics'; // lowercase
    public $base_title = "Pray4Movement Prayer Points Metrics";
    ...
    public function scripts() {
        ...
        wp_localize_script(
            'dt_'.$this->slug.'_script', $this->js_object_name, [
                ...
                'translations' => [
                    "title" => $this->title,
                    "Sample API Call" => __( "Sample API Call", 'pray4movement-prayer-points' )
                ]
            ]
        );
    }
